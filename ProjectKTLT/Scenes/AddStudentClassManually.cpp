...
AddStudentClassManuallyScene::AddStudentClassManuallyScene(Static* a)
{
	...
	createABox(id, sf::Vector2f(400.0f, 150.0f), a->highlightCyan, sf::Vector2f(a->width / 2.0f - 600.0f, 350.0f));
	...
	createABox(lastname, sf::Vector2f(400.0f, 150.0f), a->highlightCyan, sf::Vector2f(a->width / 2.0f, 350.0f));
	...
	createABox(gender, sf::Vector2f(400.0f, 150.0f), a->highlightCyan, sf::Vector2f(a->width / 2.0f - 600.0f, 600.0f));
	createText(genderText, a->fontN, sf::Color::White, "", 40, gender.getPosition().x, gender.getPosition().y);
	createText(enterGenderHere, a->fontI, sf::Color::White, "ENTER GENDER NAME HERE", 25, gender.getPosition().x, gender.getPosition().y);

	createABox(birthday, sf::Vector2f(400.0f, 150.0f), a->highlightCyan, sf::Vector2f(a->width / 2.0f, 600.0f));
	...
	createABox(sID, sf::Vector2f(400.0f, 150.0f), a->highlightCyan, sf::Vector2f(a->width / 2.0f + 600.0f, 600.0f));
...
void AddStudentClassManuallyScene::renderAddManually(sf::Event event, Scene* scene, sf::RenderWindow& win)
{
	...
	if (event.type == sf::Event::MouseButtonPressed)
	{
		if (event.mouseButton.button == sf::Mouse::Left)
		{
			...
			{
				Class* cl = new Class;
				int check = cl->insert_new_Class_keyboard(scene->a, idInput, firstnameInput, lastnameInput, genderInput, birthdayInput, sIDInput);
