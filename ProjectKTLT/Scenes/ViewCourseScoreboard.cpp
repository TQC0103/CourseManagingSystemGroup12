...
ViewScoreboardCourseScene::ViewScoreboardCourseScene(Static* a)
{
	...
	createText(title, a->fontB, a->textColorBlue, "Course Scoreboard", 60, (float)a->width / 2.0f, 75.0f);
	createText(viewScoreCourseText, a->fontB, a->textColorBlue, a->curCourse->Name + " - " + a->curCourse->className, 60, (float)a->width / 2.0f, 150.0f);
