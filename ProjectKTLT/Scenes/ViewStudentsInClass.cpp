...
ViewStudentInClassScene::ViewStudentInClassScene(Static* a)
{
	...
	createAScrollbar(scrollbar, scrollbarArea, sf::Vector2f(20.0f, 50.0f), a->backGroundWhiteDarkerStill, a->backGroundWhiteDarker, sf::Vector2f(1900.0f, 625.0f), 15);
...
void ViewStudentInClassScene::drawViewStudentInClassScene(sf::RenderWindow& window, Static* a)
{
	...
	drawScrollBar(scrollbar, scrollbarArea, window, scrollOffset, sizedisplay, fullsize, sf::Vector2f(1900.0f, 275.0f));
