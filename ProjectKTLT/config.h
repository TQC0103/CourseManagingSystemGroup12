...
ViewCoursesStudent, ViewScoreboardStudent, AddCourseToSemester, ViewStudentInClass, UpdateCourseInformation, AddClassCourse, ViewCourseScoreboard, ViewCourseStudent, ChooseSchoolYearClass, ChooseSemesterClass, ViewClassScoreboard
};
struct Static
{
