...
#include <string>
	...
	struct studentScore {
		...
		studentScore(int number, const std::string& id, const std::string& first, const std::string& last, double final, double midterm, double other, double total, studentScore* next = nullptr)
